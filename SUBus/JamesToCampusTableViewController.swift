//
//  JamesToCampusTableViewController.swift
//  SUBus
//
...
class JamesToCampusTableViewController : UITableViewController
{
    var busClassObj = JamesToCampus(name: "bus")
    var indexToShow: Int!
    ...
    override func viewDidLoad() {
        ...
        // indexToShow
        print("index to show: \(indexToShow)")
